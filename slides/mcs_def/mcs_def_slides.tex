...
\label{sec:org0e0c836}

\section*{Design and Implementation of ROPER}
\label{sec:org3b6cbfe}

\section*{Experimental Studies}
\label{sec:org2295ab7}

\subsection*{The Environment}
\label{sec:orgefa59b3}
\begin{center}
...
\label{sec:org2407370}

\subsubsection*{Quasi-Homologous Crossover}
\label{sec:org78a9005}

\subsection*{}
\label{sec:org5bcb2dc}
\end{document}