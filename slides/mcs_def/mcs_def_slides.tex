...
\label{sec:org4413ae7}

\section*{Design and Implementation of ROPER}
\label{sec:org2d404b5}

\section*{Experimental Studies}
\label{sec:org610c699}

\subsection*{The Environment}
\label{sec:orgb18d7b7}
\begin{center}
...
\label{sec:org4661e23}

\subsubsection*{Quasi-Homologous Crossover}
\label{sec:orgaf2098c}

\subsection*{}
\label{sec:orgf7b5030}
\end{document}