...
set out "~/thesis/images/plots/sharing.pdf"
...
plot "./roper_15-04-15.csv" every 64 u 2:16 w lines lc 1 title 'Setosa Difficulty',   "" every 64 u 2:($16+$17):($16-$17) w filledcurves lc 1 notitle,   "" every 64 u 2:18 w lines lc 2 title 'Versicolor Difficulty',   "" every 64 u 2:($18+$19):($18-$19) w filledcurves lc 2 notitle,   "" every 64 u 2:20 w lines lc 3 title 'Virginia Difficulty',   "" every 64 u 2:($20+$21):($20-$21) w filledcurves lc 3 notitle, "" u 2:"AVG-ABFIT" w lines smooth bezier title "Mean Detection Rate Error", "" u 2:"BEST-ABFIT" w lines title "Champion's Detection Rate Error", "" u 2:"CRASH" with lines smooth bezier title "Crash Rate" lc rgb "orange"
