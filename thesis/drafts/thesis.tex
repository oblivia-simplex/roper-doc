...
\label{sec:orgc0ac3fb}
\label{orgbf6adad}
\section{What is the aim of this research?}
\label{sec:org0f89cde}
\label{orgc8f8680}
...
\label{sec:orgab5a2a1}
\label{org0cd22d6}
\subsection{1969: Benford}
\label{sec:org01633ad}
...
a surprising degree of ruggedness, as we can see in figure \ref{fig:orgbe0dc9b}. 

\begin{figure}[htbp]
\centering
\includegraphics[width=.9\linewidth]{../images/plots/wiwzuh_syscall_gaussian_3.pdf}
\caption{\label{fig:orgbe0dc9b}
...
As we can see in figure \ref{fig:orgbc0bf4a}, \emph{even the linearly inseparable} 
