...
\label{sec:orgf9b22a0}
\label{orgf09875c}
\section{What is the aim of this research?}
\label{sec:orge602da3}
\label{org51d0a8a}
...
\label{sec:orgb0713b6}
\label{orgf2474b9}
\subsection{1969: Benford}
\label{sec:org96a4e62}
...
a surprising degree of ruggedness, as we can see in figure \ref{fig:org7d300ee}. 

\begin{figure}[htbp]
\centering
\includegraphics[width=.9\linewidth]{../images/plots/wiwzuh_syscall_gaussian_3.pdf}
\caption{\label{fig:org7d300ee}
