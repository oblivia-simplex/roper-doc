...
\label{sec:orgdf571e7}
\label{orga455d11}
\section{What is the aim of this research?}
\label{sec:org9cef281}
\label{org506d05d}
...
\label{sec:org6dd4e8f}
\label{orgc155133}
\subsection{1969: Benford}
\label{sec:org7207620}
...
a surprising degree of ruggedness, as we can see in figure \ref{fig:org7f41952}. 

\begin{figure}[htbp]
\centering
\includegraphics[width=.9\linewidth]{../images/plots/wiwzuh_syscall_gaussian_3.pdf}
\caption{\label{fig:org7f41952}
...
As we can see in figure \ref{fig:orgcd30e56}, \emph{even the linearly inseparable} 
