...
#+LATEX: \footnote{In the immortal words of Pastor Manul Laphroaig \cite{laphroaig13}:
#+LATEX:  \begin{quote}
...
Galen Wolff-Pauly \aimention{Galen Wolff-Pauly} in designing the /Urbit/ namespace,
 and used strings of six random
letters, following the pattern "=consonant vowel consonant consonant vowel
consonant="[fn:: This superficially resembles the namespace allocated to
"stars" in /Urbit/, but is a bit less constrained: Urbit's namespace has room for
...
studied in the course of this thesis. Please see \S [[sec:terminology]] for an explanation
