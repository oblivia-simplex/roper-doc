...
*** Experimental results of implementing quasi-homologous crossover in ROPER
...
frequency at which crossover-span exhibit a fitness /superior/ to the average
of their parents'. 
...
of letting the paternal segment of the offspring /pick up where the maternal segment
...
*** Preliminary results of visitation novelty pressure

** The clump TTL mechanism and the ecological role of extinction events

*** Combining visitation novelty pressure with a TTL field
